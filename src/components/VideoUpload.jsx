...
import videoLogo from "../assets/video-marketing.png";
import { Button, Card , Label, FileInput, TextInput, Textarea } from 'flowbite-react';
...
function VideoUpload() {
  ...
  return <div className="text-white">
    ...
    <Card className="flex flex-col item-center justify-center"> 
     ...
     <form
     noValidate
      className=" flex flex-col space-y-7" onSubmit={handleForm} >
    ...
    <div className="max-w-md">
      ...
      <div className="flex items-center space-x-5 justify-cemter">
